...
**중요: 모든 이벤트에 정확한 날짜와 한국시간(KST)을 반드시 포함하세요!**

• [1월 3일(금) 22:30 KST] 미국 고용지표 발표 - 비농업 고용, 실업률

• [1월 8일(수) 04:00 KST] FOMC 의사록 공개

• [1월 15일(수) 22:30 KST] 미국 CPI 발표

• [글로벌/지정학 이벤트도 동일하게 날짜+시간 포함]
